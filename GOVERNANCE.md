...
`cloud-itonami-isic-2821` is an OSS open-business blueprint for
agricultural/forestry-machinery plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- an assembly/test-bench-equipment action the governor refuses is never dispatched to hardware.
- the Agricultural and Forestry Machinery Plant Operations Governor remains independent of the advisor.
