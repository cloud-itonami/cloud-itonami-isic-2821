# Operator Quickstart — Manufacture of agricultural and forestry machinery

Shortest path from clone to a verified local dry-run for **ISIC 2821** (`cloud-itonami-isic-2821`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2821.git
cd cloud-itonami-isic-2821
```
...
- Blueprint governor key: `agricultural-forestry-machinery-plant-operations-governor`
- Likely source path: `agmachmfg.governor.cljc`
