# Business Model: Manufacture of agricultural and forestry machinery
...
## Classification
- Repository: `cloud-itonami-isic-2821` ([github.com/cloud-itonami/cloud-itonami-isic-2821](https://github.com/cloud-itonami/cloud-itonami-isic-2821))
- ISIC Rev.5: `2821` — Manufacture of agricultural and forestry machinery
- Domain: `:agricultural-forestry-machinery/manufacturing`
- Social impact: :worker-safety :mechanical-safety :hydraulic-safety
- Actor: `:agricultural-forestry-machinery-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :agricultural-forestry-machinery/manufacturing — who wants
...
One managed tenant (:agricultural-forestry-machinery/manufacturing):
...
- Do not bypass the `:agricultural-forestry-machinery-plant-operations-governor` for production decisions.
