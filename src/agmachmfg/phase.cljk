(ns agmachmfg.phase
  "Phase 0->3 staged rollout for the agricultural/forestry-machinery
  (tractors, combine harvesters, tillage implements, balers and
  forestry harvesters) plant-operations coordination actor.
  ...
  `agmachmfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map an Agricultural and Forestry Machinery Plant Operations
